...
import 'packaging_info_widget_1_lines.dart';
import 'rating_bar_with_raters_count.dart';

class ProductListCard2 extends GetView<CartController> {
                            ...
                            child: Container(
                              ...
                              child: FlatButton(
                                ...
                                shape: RoundedRectangleBorder(
                                  borderRadius: !_settingsCon.pointsEnabled ||
                                          product.points == 0
                                      ? BorderRadius.only(
                                          bottomLeft: Radius.circular(15),
                                          bottomRight: Radius.circular(15),
