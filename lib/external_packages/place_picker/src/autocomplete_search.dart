...
import '../../../external_packages/place_picker/providers/place_provider.dart';
import '../../../external_packages/place_picker/providers/search_provider.dart';
...
class AutoCompleteSearchState extends State<AutoCompleteSearch> {
  ...
  _onSearchInputChange() {
    ...
    if (controller.text.trim() == this.provider.getPrevSearchTerm.trim()) {
      provider.debounceTimer?.cancel();
      return;
    }
