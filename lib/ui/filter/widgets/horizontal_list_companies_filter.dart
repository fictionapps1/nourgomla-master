...
class HorizontalListCompaniesFilter extends StatelessWidget {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlatButton(
                      onPressed: () {
                        if (_filterController.selectedCompany != '') {
                          _filterController.resetCompaniesFilter();
                          applyFilter();
                        }
                      },
                            ...
                            children: [
                              Container(
                                child: ImageButton(
                                  ...
                                  onPressed: () {
                                    _filterController.selectedCompany =
                                        category.id.toString();
                                    applyFilter();
                                    _filterController.selectFilter(_filterController.filterEntries[1], category);
                                  },
                                  boxFit: BoxFit.fill,
                                ),
                              ),
