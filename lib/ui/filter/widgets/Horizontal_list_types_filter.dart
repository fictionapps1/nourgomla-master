...
class HorizontalListTypesFilter extends StatelessWidget {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlatButton(
                      onPressed: () {
                        if (_filterController.selectedType != '') {
                          _filterController.resetTypesFilter();
                          applyFilter();
                        }
                      },
                            ...
                            children: [
                              Container(
                                child: ImageButton(
                                  ...
                                  onPressed: () {
                                    _filterController.selectedType =
                                ...
                                child: ImageButton(
                                  ...
                                  onPressed: () {
                                    _filterController.selectedType =
                                        category.id.toString();
                                    applyFilter();
                                    _filterController.selectFilter(_filterController.filterEntries[3], category);
